...
extern int scanhash_renesis(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_renesis(int thr_id);
...
void renesis_hash(void *output, const void *input);
